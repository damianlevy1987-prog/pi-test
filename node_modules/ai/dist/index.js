...
var object = ({
  ...
  const schema = (0, import_provider_utils12.asSchema)(inputSchema);
  return {
    name: "object",
    responseFormat: (0, import_provider_utils12.resolve)(schema.jsonSchema).then((jsonSchema2) => ({
      type: "json",
      schema: jsonSchema2,
    ...
    async parseCompleteOutput({ text: text2 }, context2) {
      const parseResult = await (0, import_provider_utils12.safeParseJSON)({ text: text2 });
...
var array = ({
  ...
  const elementSchema = (0, import_provider_utils12.asSchema)(inputElementSchema);
  return {
    name: "array",
    // JSON schema that describes an array of elements:
    responseFormat: (0, import_provider_utils12.resolve)(elementSchema.jsonSchema).then((jsonSchema2) => {
...
async function parseToolCall({
  ...
  try {
      ...
      try {
        repairedToolCall = await repairToolCall({
          ...
          inputSchema: async ({ toolName }) => {
            ...
            return await (0, import_provider_utils13.asSchema)(inputSchema).jsonSchema;
          },
          system,
          messages,
          error
    ...
    const parsedInput = await (0, import_provider_utils13.safeParseJSON)({ text: toolCall.input });
...
async function parseProviderExecutedDynamicToolCall(toolCall) {
  const parseResult = toolCall.input.trim() === "" ? { success: true, value: {} } : await (0, import_provider_utils13.safeParseJSON)({ text: toolCall.input });
...
async function doParseToolCall({
  ...
  const schema = (0, import_provider_utils13.asSchema)(tool2.inputSchema);
  const parseResult = toolCall.input.trim() === "" ? await (0, import_provider_utils13.safeValidateTypes)({ value: {}, schema }) : await (0, import_provider_utils13.safeParseJSON)({ text: toolCall.input, schema });
  if (parseResult.success === false) {
    throw new InvalidToolInputError({
      toolName,
      toolInput: toolCall.input,
...
// src/generate-text/generate-text.ts
var originalGenerateId = (0, import_provider_utils14.createIdGenerator)({
  prefix: "aitxt",
  size: 24
});
...
var uiMessageChunkSchema = (0, import_provider_utils15.lazySchema)(
          ...
          async function updateMessageMetadata(metadata) {
            if (metadata != null) {
              ...
              if (messageMetadataSchema != null) {
                await (0, import_provider_utils16.validateTypes)({
          ...
          try {
            ...
            if (toolCall.invalid) {
              toolResultsStreamController.enqueue({
                ...
                toolName: toolCall.toolName,
                input: toolCall.input,
                error: (0, import_provider_utils17.getErrorMessage)(toolCall.error),
                dynamic: true,
...
var DefaultStreamTextResult = class {
  constructor({
    ...
    this._totalUsage = new import_provider_utils18.DelayedPromise();
    this._finishReason = new import_provider_utils18.DelayedPromise();
    this._rawFinishReason = new import_provider_utils18.DelayedPromise();
    this._steps = new import_provider_utils18.DelayedPromise();
    ...
    let stream = new ReadableStream({
      ...
      async pull(controller) {
        ...
        try {
          ...
          if ((0, import_provider_utils18.isAbortError)(error) && (abortSignal == null ? void 0 : abortSignal.aborted)) {
            abort();
          } else {
            controller.error(error);
          }
    ...
    recordSpan({
      ...
      fn: async (rootSpanArg) => {
        ...
        async function streamStep({
          ...
          try {
            stepFinish = new import_provider_utils18.DelayedPromise();
            const stepInputMessages = [...initialMessages, ...responseMessages];
            const prepareStepResult = await (prepareStep == null ? void 0 : prepareStep({
              model,
              steps: recordedSteps,
...
var ToolLoopAgent = class {
  ...
  async prepareCall(options) {
    ...
    if (this.settings.callOptionsSchema != null && options.options !== void 0) {
      const validatedOptions = await (0, import_provider_utils19.validateTypes)({
